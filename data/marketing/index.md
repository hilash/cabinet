...
**Channels:** Instagram (primary), TikTok (growth), Email (retention), Blog (SEO)

**Core message:** Real chocolate, real ingredients, delivered to your door. No gimmicks.

**Target audience:** Health-conscious millennials and Gen Z who read ingredient labels but still want chocolate that *actually tastes good*.
...
When writing blog posts or social copy in this KB, try the slash command menu — type `/` in any page to quickly insert headings, callouts, tables, and code blocks without touching the toolbar.

## Key Metrics

- **CAC:** $12 target (currently $15)
- **Email open rate:** 38%
- **Instagram engagement:** 4.2%
- **Subscription conversion:** 22% of first-time buyers
