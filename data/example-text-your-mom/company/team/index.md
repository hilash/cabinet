...
Full roster for Text Your Mom as of April 13, 2026. Sixteen people across four departments.

---

## Executive Leadership (Root Cabinet)

| # | Role | Focus | Status | Heartbeat |
|---|------|-------|--------|-----------|
| 1 | **CEO** | Strategy, prioritization, company rhythm | Active | Weekdays 9am |
| 2 | **COO** | Operations, review rhythm, unblockers | Active | Weekdays 10am |
| 3 | **CFO** | Runway, paid conversion, pricing | Active | Mondays 9am |
| 4 | **CTO** | Architecture, release readiness, product constraints | Active | Weekdays 9am |
...
| # | Role | Focus | Status |
|---|------|-------|--------|
| 5 | **CTO (Engineering)** | Architecture, delivery, reliability | Active |
| 6 | **Product Manager** | Prioritization, onboarding, retention | Active |
| 7 | **DevOps Engineer** | Release process, monitoring, reliability | Active |
| 8 | **QA Agent** | Bug triage, trust risks, release quality | Active |

---

## Marketing — TikTok Growth
...
| Department | Active | Paused | Total |
|------------|--------|--------|-------|
